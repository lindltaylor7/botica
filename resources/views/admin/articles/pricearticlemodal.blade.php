        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('articles.update',$articulo->id)}}" method="POST">
                    @csrf
                    @method('put')
                    <input type="hidden" name="number_box" id="number_box_edit" value="{{$articulo->number_box}}">
                    ...
                    <section>
                        ...
                        <div class="form-row">
                            <div class="form-col">
                                ...
                                <div class="form-holder">
                                    <i>S./</i>
                                    <input type="text" name="cost_box" id="cost_box_edit" class="form-control" placeholder="Costo por Caja" value="">
                                </div>
                            </div>
                            <div class="form-col">
                                ...
                                <div class="form-holder">
                                    <i>%</i>
                                    <input type="text" id="utility_box_edit" class="form-control" placeholder="Utilidad por caja">
                            ...
                            <div class="form-col">
                                ...
                                <div class="form-holder">
                                    <i>S./</i>
                                    <input type="text" id="sale_price_box_edit" class="form-control" placeholder="P. de venta por caja" readonly>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-col">
                                ...
                                <div class="form-holder">
                                    <i>S./</i>
                                    <input type="text" name="sale_price" id="sale_price_unit" class="form-control" placeholder="P. de venta por unidad" readonly value="{{$articulo->price->sale_price}}">
